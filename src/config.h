...
// Creates a delay between the direction pin setting and corresponding step pulse.
// This is now implemented at zero-cost using a separate timer in one-pulse mode.
#define STEP_PULSE_DELAY 10 // Step pulse delay in nano-seconds (minumum 10).
